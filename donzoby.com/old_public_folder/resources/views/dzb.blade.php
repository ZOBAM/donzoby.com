...
<div class='container-fluid' id='main-content'>
    ...
    <div class="card-deck"><!------------------------Web design card-deck begins ------------------------------>
      <div class="card-body">
		...
		<div class="row">
			<img class="col-sm-4" src="{{URL('public/images/dzb-web-design.png')}}" alt="Card image">
	...
	<div class="card-deck"><!---------------------------Graphics card-deck begins ------------------------------->
      <div class="card-body">
		...
		<div class="row">
			<img class="col-sm-4" src="{{URL('public/images/dzb-graphics.png')}}" alt="Card image">
	...
	<div class="card-deck"><!-------------------------mobile-app card-deck begins ----------------------------->
      <div class="card-body">
		...
		<div class="row">
			<img class="col-sm-4" src="{{URL('public/images/dzb-web-dev.png')}}" alt="Card image">
