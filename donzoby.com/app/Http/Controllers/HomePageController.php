            ...
            if (in_array($subject, $subjects)) {
				if ($id!=0) {//an id is provided
					if(is_numeric($id)){
						...
						if ($post_image) {
							//$post_image = URL('images/donzoby-logo-wtbg.png');
							$post_image = URL($post_image->link);
						}
						else{
							$post_image = URL('images/donzoby-logo-wtbg.png');
						}
						...
						if(count($comments)>0){
							...
							foreach($comments as $comment){
								...
								}else{$comments[$i]->author_image_link=URL('images/donzoby-logo-wtbg.png');}
							$i++;
							}//endforeach
						}//endif
					}//end if id is numeric
                    //$subject = 'HTML';
                    return view('single',compact('topic','subject','posts','listed_subjects','comments','description','title','post_image'));
                    ...
                    return view('subject',compact('course','subject','subject_data','posts','listed_subjects','description','title','post_image'));
                }
            }
                ...
                return view('course',compact('course','subject','posts','listed_subjects','description','title','post_image'));
            }
        }
