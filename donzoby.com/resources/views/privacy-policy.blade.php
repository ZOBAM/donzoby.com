    <x-single_col title="Privacy Policy">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" id="donzoby-info">
                    <div class="card-body">
                        <h1>Privacy Policy</h1>
                        <p>Donzoby.com operates <a href="https://www.donzoby.com"> Donzoby.com </a> website (the
                            "Service") -
                            a Tutorial website for the Elects.</p>
                        ...
                        <h2>Use of Data</h2>
                        <p>Donzoby.com uses the collected data for various purposes:</p>
                        <ul class="tw-list-disc">
                        ...
                        <p>If you are located outside Nigeria and choose to provide information to us, please note that
                            we
                            transfer the data, including Personal Data, to Nigeria and process it there.</p>
                        <p>Your consent to this Privacy Policy followed by your submission of such information
                            represents
                            your agreement to that transfer.</p>
                        <p>Donzoby.com will take all steps reasonably necessary to ensure that your data is treated
                            securely
                        ...
                        <p>Donzoby.com may disclose your Personal Data in the good faith belief that such action is
                            necessary:</p>
                        <ul class="tw-list-decimal">
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Donzoby.com</li>
                        ...
                        <ul class="tw-list-disc">
                            <li>
                                ...
                                <p>You can opt-out of having made your activity on the Service available to Google
                                    Analytics
                        ...
                        <ul class="tw-list-disc tw-ml-6">
                            <li class="">By email: info@donzoby.com</li>
                        </ul>
                    </div>
                </div>
            </div>
