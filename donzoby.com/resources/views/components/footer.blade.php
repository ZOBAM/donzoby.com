    ...
    <div class = 'container-fluid'>
        <div class='row'>
            ...
            <div class="col-sm-4 tw-mb-3">
                ...
                <a href="/mobile-app-dev">Mobile Development</a><br />
            </div>
        </div>
    </div>
    <div class = 'container-fluid'>
        <div class="row" style="color:#EFF1EF;background-color: #3C3C3C">
            ...
            <div class="col-sm-3 tw-text-sm">Email: info@donzoby.com</div>
            <div class="col-sm-6 tw-text-sm">Besides Bricks Estate, New Layout, Enugu State. </div>
            <div class="col-sm-3 tw-text-sm">Tel: +2349057965147</div>
        </div>
    </div>
</footer>
