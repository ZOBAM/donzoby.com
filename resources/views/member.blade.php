...
<div class='container-fluid' id='main-content'>
    ...
    <div class="col-md-2" id="side-bar-links">
     ...
     <!--  very bad approach, change as soon as possible! -->
              @php
              $pic_link = URL('images/donzoby-logo-wtbg.png');
              @endphp
        ...
        <form method="POST" action="{{ url('/image-upload') }}" enctype="multipart/form-data">
         ...
         <form method="POST" action="{{ url('post') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select name="post_type" id="type" class="form-control" >
                        <option value="course series">Course Series</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select id="subject" class="form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" name="subject" value="{{ old('subject') }}" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <label><input type="checkbox" name="is_grouped" id="is_grouped"> Is Grouped</label>
                </div>
            </div>
            <div class="form-group row d-none" id="select-group">
                <label for="topic" class="col-sm-2 col-form-label text-sm-right">{{ __('Group') }}</label>
                <div class="col-sm-4">
                    <select name="" id="group" class="form-control">
                        <option value=''>Choose Post Group</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select id="post_status" class="form-control{{ $errors->has('post_status') ? ' is-invalid' : '' }}" name="post_status" value="{{ old('post_status') }}" required >
                        ...
                        <option value="not_published">Publish Later</option>
                    </select>
